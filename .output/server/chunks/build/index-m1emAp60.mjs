  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({
        ...
        id: "workshops"
      }, _attrs))} data-v-47ceef88>`);
      _push(ssrRenderComponent(_component_AppContainer, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="mx-auto max-w-6xl px-6 sm:px-10 md:px-14 lg:px-20" data-v-47ceef88${_scopeId}><div class="mb-12 text-center sm:mb-16" data-v-47ceef88${_scopeId}><p class="mb-2 text-xs font-medium uppercase tracking-[0.35em] text-[var(--color-accent)]" data-v-47ceef88${_scopeId}> Workshops </p><h2 class="font-serif text-2xl font-light text-[var(--color-text)] sm:text-3xl md:text-4xl" data-v-47ceef88${_scopeId}> Al-Tira · Jiva · Retreat </h2></div><div class="grid gap-6 sm:gap-8 lg:grid-cols-3 lg:gap-8" data-v-47ceef88${_scopeId}><!--[-->`);
            ssrRenderList(workshops, (workshop, index2) => {
              _push2(`<article class="workshop-card group" data-v-47ceef88${_scopeId}><div class="workshop-card-inner flex flex-col overflow-hidden" data-v-47ceef88${_scopeId}><div class="workshop-card-image-wrap" data-v-47ceef88${_scopeId}><img${ssrRenderAttr("src", workshop.image)}${ssrRenderAttr("alt", workshop.title)} class="workshop-card-image" loading="lazy" data-v-47ceef88${_scopeId}></div><div class="workshop-card-body flex flex-col flex-1" data-v-47ceef88${_scopeId}><div class="workshop-card-header" data-v-47ceef88${_scopeId}><span class="workshop-card-tag" data-v-47ceef88${_scopeId}>${ssrInterpolate(workshop.tag)}</span><h3 class="workshop-card-title font-serif" data-v-47ceef88${_scopeId}>${ssrInterpolate(workshop.title)}</h3></div><p class="workshop-card-desc" data-v-47ceef88${_scopeId}>${ssrInterpolate(workshop.description)}</p><div class="workshop-card-footer" data-v-47ceef88${_scopeId}><span class="workshop-card-cta" data-v-47ceef88${_scopeId}>${ssrInterpolate(workshop.cta)} <span class="inline-block transition-transform duration-200 group-hover:translate-x-1" data-v-47ceef88${_scopeId}>→</span></span></div></div></div></article>`);
            });
            _push2(`<!--]--></div></div>`);
          } else {
            return [
...
const __nuxt_component_4 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-47ceef88"]]), { __name: "SectionsWorkshopsSection" });
...
//# sourceMappingURL=index-m1emAp60.mjs.map
